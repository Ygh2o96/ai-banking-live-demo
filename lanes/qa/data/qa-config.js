  ...
  window.QA_EVIDENCE_CONFIG = Object.freeze({
    ...
    cases: Object.freeze([
      ...
      Object.freeze({
        ...
        title: "公牛集团 · 现场生成模型",
        status: "演示时实时生成 · r3",
        summary: "本次演示会话生成并修订的36个月经营驱动模型。历史映射复用已准备的公开资料；最终版本含会话内后续修订与复核。",
        ...
        links: Object.freeze([
          ...
          Object.freeze({ label: "打开一页说明 PDF", href: "../../live/financial-model/GONGNIU_PFM_ONE_PAGE_r3.pdf" }),
        ]),
        metadata: Object.freeze([
          Object.freeze({ label: "生成版本", value: "2026-09-06 演示会话 · 最终修订 r3" }),
          Object.freeze({ label: "模型范围", value: "产品量价、生产库存、人工费用、资产融资与月度三表" }),
          Object.freeze({ label: "使用边界", value: "公开教学版本；现金缺口与未证实假设保留" }),
        ]),
      }),
    ]),
  });
